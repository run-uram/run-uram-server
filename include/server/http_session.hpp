...
private:
    net::awaitable<void> HandleHttpRequest(http::request<http::string_body> req)
    {
        sys::error_code ec;
        http::response<http::string_body> res = co_await m_http_controller->HandleRequest(std::move(req));
